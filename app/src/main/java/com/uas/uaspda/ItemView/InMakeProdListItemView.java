 ...
 */
public class InMakeProdListItemView extends LinearLayout {
    ...
    public static final String TAG_TVMARK = "tvMark";
    private TextView tvInoutNum, tvClass, tvWhcode, tvMark;


    @SuppressLint("NewApi")
    public InMakeProdListItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        // this.tvId = tvId;
    }

    public InMakeProdListItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    public InMakeProdListItemView(Context context) {
        super(context);
        initView(context);
    }
    ...
    private void initView(Context context) {
        ...
        lowerLayout.addView(tvMark,tvLowerParams);
